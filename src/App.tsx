    ...
    const refresh = async () => {
      ...
      setGame((current) => {
        ...
        if (current.mode === "normal") {
          ...
          if (orbitalStation !== current.orbitalStation) {
            next = reconcileOrbitalCargoTerminalBindings({ ...current, orbitalStation });
          }
        }
        if (!response.activity!.enabled) return next;
        ...
        return synchronizeGalacticActivity(next, response.activity!, participantId);
      });
    };
    void refresh();
    ...
    >
      ...
      <div className="game-workspace">
        ...
        >
          ...
          {game.mode === "normal" ? <div className="canvas-global-navigation nodrag nopan">
            <button
          ...
          </div> : <PlanetNavigator game={observedGame} onPlanetChange={onPlanetChange} />}
      ...
      <Suspense fallback={<WorkspaceLoading />}>
        ...
        /> : null}
        {orbitalStationOpen ? <OrbitalStationWorkspace
          game={game}
