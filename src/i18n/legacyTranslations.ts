...
const UI_EN: TranslationMap = {
  ...
  "交接中": "Transitioning",
  "传统模式": "Legacy Mode",
  "只向共享库存上传当前采集气体，并与量子塔供应槽共享全局上传额度。": "Uploads the currently collected gas to shared inventory and shares the global upload budget with quantum tower supply slots.",
