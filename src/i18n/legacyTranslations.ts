...
const UI_EN: TranslationMap = {
  ...
  "云存档、蓝图与终局稳定性更新": "Cloud Saves, Blueprints & Endgame Stability Update",
  "1.0.21 修复大存档云上传边界、存档读取与蓝图界面稳定性问题，降低终局工厂的主线程压力，并保留旧存档、库存、线路和在途物资。GameState v46、云 schema v7 与存档格式保持兼容。": "Version 1.0.21 fixes large-save cloud upload limits, save loading, and blueprint UI stability, reducing main-thread pressure in endgame factories while preserving old saves, inventories, belts, and in-transit cargo. GameState v46, cloud schema v7, and the save format remain compatible.",
  ...
  "大存档云上传与读取保护": "Large-save Cloud Upload & Read Protection",
  "云存档请求支持更大的合法正文并分别提示格式、完整性和体积错误；上传前后保留校验、事务和上一份有效云档，读取失败仍显示真实摘要。": "Cloud-save requests accept larger valid payloads and distinguish format, integrity, and size errors. Validation, transactions, and the previous valid cloud save are preserved, while failed reads still show the real summary.",
