...
import { getPlanetMetrics, isPlanetColonized } from "../../game/engine";
...
export function MobileSheets({ game, alerts, overlay, tools, toolActions, factory, factoryActions, onSheetSnap, onClose, onPlanetChange, onOpenStarMap, onConfirmExit, onDismissExit }: {
  ...
  if (overlay.id === "inventory") return <MobileInventorySheet game={game} snap={overlay.snap} onSnap={onSheetSnap} onClose={onClose} onPickTray={factoryActions.onPickTray} onDropCargo={factoryActions.onDropCargo} />;
