...
test("reports the 1.0.39 candidate version and a unique build id", async ({ page }) => {
  ...
  expect(application.version).toBe("1.0.39");
  expect(application.build).toMatch(/^1\.0\.39\+[0-9a-f]{12}(?:\.dirty)?$/);
});
