...
test("native feed generator creates bounded Android and desktop update feeds", async () => {
  ...
  try {
    ...
    assert.equal(android.versionName, "1.0.3");
    assert.match(android.apk.url, /^https:\/\/dsponline\.cn\/downloads\/android\/dsp-idle-1\.0\.3-1000003\.apk$/);
    ...
    assert.equal(desktop.version, "1.0.3");
