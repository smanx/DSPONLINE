...
> **当前发布基线（2026-08-10）**：当前正式版本使用 `1.0.36 / GameState v46`；有效资产的 v43 空间站实验存档拒绝加载。量子网络回归以 GameState v46 语义为基线，并保留传统物流站升级兼容测试。1.0.36 不升级存档 envelope、云 schema 或 SQLite layout。
