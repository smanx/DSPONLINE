...
| 夹具 | 摘要 |
| --- | --- |
| 小档 | 本机受保护附件；SHA-256 `F62454361555FCA88C96F398AA34A4BFAA482E1A90E3651ADF308ADE85334F58`；305,254 字节；225 实体；191 线路 |
| 大档 | 本机受保护附件；SHA-256 `0A251ADEFA5E467C6F4FDBBA2964623D295E499A9CB48EED814A10B37B18F4E7`；3,905,264 字节；1,910 实体；4,479 线路；无限科研 `matrix_compression` 263 级 |
