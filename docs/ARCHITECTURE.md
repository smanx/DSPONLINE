...
2. `1.0.5` 的 `FactoryGame` 以 `GameState` v37 作为唯一持久游戏状态；v1-v36 由连续迁移链归一到 v37，存档 envelope 仍为 v2。
...
| 数据 | 键或位置 | 说明 |
| --- | --- | --- |
| 主存档 | `dsp-idle-network.save.v1` | v2 envelope；`1.0.5` 写 v37并可迁移 v1-v36；`productionHistory` 始终以空数组写入 |
