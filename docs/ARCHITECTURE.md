...
2. `1.0.2` 的 `FactoryGame` 以 `GameState` v35 作为唯一持久游戏状态；v1-v34 由连续迁移链归一到 v35，存档 envelope 仍为 v2。
...
| 数据 | 键或位置 | 说明 |
| --- | --- | --- |
| 主存档 | `dsp-idle-network.save.v1` | v2 envelope；`1.0.2` 写 v35并可迁移 v1-v34；`productionHistory` 始终以空数组写入 |
