...
Current workspace and deployed `0.4.0` baseline: 254 Vitest tests, 93 Playwright Chrome tests, and 22 Node server tests, with game state v28 and cloud schema v6.
